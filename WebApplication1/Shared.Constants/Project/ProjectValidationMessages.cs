namespace Shared.Constants.Project
{
    public static class ProjectValidationMessages
    {
        ...
        public const string EnterPriority = "Введите приоритет проекта";
        public const string PriorityRange = "Приоритетом проекта должно быть целочисленное значение >= 0";
